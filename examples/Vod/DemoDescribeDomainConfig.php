...
$request = new Volc\Service\Vod\Models\Request\VodDescribeDomainConfigRequest();
$request->setSpaceName("your SpaceName");
$request->setDomainType("your DomainType");
$request->setDomain("your Domain");


$response = new Volc\Service\Vod\Models\Response\VodDescribeDomainConfigResponse();
try {
    $response = $client->describeDomainConfig($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
