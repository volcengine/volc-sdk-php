...
$request = new Volc\Service\Vod\Models\Request\VodUpdateDomainExpireV2Request();
...
$response = new Volc\Service\Vod\Models\Response\VodUpdateDomainExpireV2Response();
try {
    $response = $client->updateDomainExpire($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
