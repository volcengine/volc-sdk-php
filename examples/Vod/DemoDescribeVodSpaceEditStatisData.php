...
$request = new Volc\Service\Vod\Models\Request\DescribeVodSpaceEditStatisDataRequest();
...
$response = new Volc\Service\Vod\Models\Response\DescribeVodSpaceEditStatisDataResponse();
try {
    $response = $client->describeVodSpaceEditStatisData($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
