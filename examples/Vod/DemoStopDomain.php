...
$request = new Volc\Service\Vod\Models\Request\VodStopDomainRequest();
...
$response = new Volc\Service\Vod\Models\Response\VodStopDomainResponse();
try {
    $response = $client->stopDomain($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
