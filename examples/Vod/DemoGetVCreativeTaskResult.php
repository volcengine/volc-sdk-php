...
$request = new Volc\Service\Vod\Models\Request\VodGetVCreativeTaskResultRequest();
$request->setVCreativeId("your VCreativeId");


$response = new Volc\Service\Vod\Models\Response\VodGetVCreativeTaskResultResponse();
try {
