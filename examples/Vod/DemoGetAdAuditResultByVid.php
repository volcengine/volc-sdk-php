...
$request = new Volc\Service\Vod\Models\Request\VodGetAdAuditResultByVidRequest();
$request->setSpaceName("your SpaceName");
$request->setVid("your Vid");
$request->setFileIds(["your FileIds"]);


$response = new Volc\Service\Vod\Models\Response\VodGetAdAuditResultByVidResponse();
try {
    $response = $client->getAdAuditResultByVid($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
