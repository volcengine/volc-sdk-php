...
// source: describeVodVidTrafficFileLog
// DO NOT EDIT!
<?php
...
$request = new Volc\Service\Vod\Models\Request\DescribeVodVidTrafficFileLogRequest();
$request->setSpaceList("your SpaceList");
$request->setStartTime("your StartTime");
$request->setEndTime("your EndTime");


$response = new Volc\Service\Vod\Models\Response\DescribeVodVidTrafficFileLogResponse();
try {
    $response = $client->describeVodVidTrafficFileLog($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
