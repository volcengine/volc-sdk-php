...
$request = new Volc\Service\Vod\Models\Request\VodAddDomainToSchedulerRequest();
...
$response = new Volc\Service\Vod\Models\Response\VodAddDomainToSchedulerResponse();
try {
    $response = $client->addDomainToScheduler($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
