...
$request = new Volc\Service\Vod\Models\Request\VodExtractMediaMetaTaskRequest();
$request->setVid("your Vid");


$response = new Volc\Service\Vod\Models\Response\VodExtractMediaMetaTaskResponse();
try {
    $response = $client->extractMediaMetaTask($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
