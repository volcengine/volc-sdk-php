...
$request = new Volc\Service\Vod\Models\Request\VodVerifyDomainOwnerRequest();
$request->setDomain("your Domain");
$request->setVerifyType("your VerifyType");


$response = new Volc\Service\Vod\Models\Response\VodVerifyDomainOwnerResponse();
try {
    $response = $client->verifyDomainOwner($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
