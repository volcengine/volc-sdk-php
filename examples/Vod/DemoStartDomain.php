...
$request = new Volc\Service\Vod\Models\Request\VodStartDomainRequest();
...
$response = new Volc\Service\Vod\Models\Response\VodStartDomainResponse();
try {
    $response = $client->startDomain($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
