...
$request = new Volc\Service\Vod\Models\Request\VodGetInnerAuditURLsRequest();
$request->setSpaceName("your SpaceName");
$request->setVid("your Vid");
$request->setFileNames(["your FileNames"]);


$response = new Volc\Service\Vod\Models\Response\VodGetInnerAuditURLsResponse();
try {
    $response = $client->getInnerAuditURLs($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
