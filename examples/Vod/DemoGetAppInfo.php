...
$request = new Volc\Service\Vod\Models\Request\VodGetAppInfoRequest();
$request->setAppId(0);


$response = new Volc\Service\Vod\Models\Response\VodGetAppInfoResponse();
try {
    $response = $client->getAppInfo($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
