...
$request = new Volc\Service\Vod\Models\Request\VodDeleteSpaceRequest();
$request->setSpaceName("your SpaceName");


$response = new Volc\Service\Vod\Models\Response\VodDeleteSpaceResponse();
try {
    $response = $client->deleteSpace($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
