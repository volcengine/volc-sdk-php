...
$request = new Volc\Service\Vod\Models\Request\VodGetAudioEventDetectionForAuditRequest();
$request->setVid("your Vid");
$request->setStrategy("your Strategy");


$response = new Volc\Service\Vod\Models\Response\VodGetAudioEventDetectionForAuditResponse();
try {
    $response = $client->getAudioEventDetectionForAudit($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
