...
$request = new Volc\Service\Vod\Models\Request\VodCreateCdnPreloadTaskRequest();
$request->setSpaceName("your SpaceName");
$request->setUrls("your Urls");


$response = new Volc\Service\Vod\Models\Response\VodCreateCdnPreloadTaskResponse();
try {
