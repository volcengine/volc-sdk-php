...
$request = new Volc\Service\Vod\Models\Request\VodCreateHlsDecryptionKeyRequest();
$request->setSpaceName("your SpaceName");


$response = new Volc\Service\Vod\Models\Response\VodCreateHlsDecryptionKeyResponse();
try {
