...
$request = new Volc\Service\Vod\Models\Request\VodDescribeDomainVerifyContentRequest();
$request->setDomain("your Domain");


$response = new Volc\Service\Vod\Models\Response\VodDescribeDomainVerifyContentResponse();
try {
    $response = $client->describeDomainVerifyContent($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
