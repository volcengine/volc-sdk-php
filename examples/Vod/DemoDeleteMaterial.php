...
$request = new Volc\Service\Vod\Models\Request\VodDeleteMaterialRequest();
$request->setMid("your Mid");
$request->setSpaceName("your SpaceName");


$response = new Volc\Service\Vod\Models\Response\VodDeleteMaterialResponse();
try {
    $response = $client->deleteMaterial($request);
} catch (Exception $e) {
    echo $e, "\n";
} catch (Throwable $e) {
    echo $e, "\n";
