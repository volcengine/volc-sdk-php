...
class VodUrlUploadRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           上传的空间名
     *     @type \Volc\Models\Vod\Business\VodUrlUploadURLSet[]|\Google\Protobuf\Internal\RepeatedField $URLSets
     *           上传URL设置参数集合
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .Volcengine.Models.Vod.Business.VodUrlUploadURLSet URLSets = 2;</code>
     * @param \Volc\Models\Vod\Business\VodUrlUploadURLSet[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setURLSets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Volc\Models\Vod\Business\VodUrlUploadURLSet::class);
        $this->URLSets = $arr;
