...
class VodGetPrivateDrmPlayAuthResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Volc\Models\Vod\Business\VodPrivateDrmPlayAuthInfo[]|\Google\Protobuf\Internal\RepeatedField $PlayAuthInfoList
     *           播放许可信息列表
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .Volcengine.Models.Vod.Business.VodPrivateDrmPlayAuthInfo PlayAuthInfoList = 1;</code>
     * @param \Volc\Models\Vod\Business\VodPrivateDrmPlayAuthInfo[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPlayAuthInfoList($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Volc\Models\Vod\Business\VodPrivateDrmPlayAuthInfo::class);
