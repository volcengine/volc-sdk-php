 ...
 * @method array DescribeImageXAddOnQPSUsage(array $query)
 ...
 * @method array CreateImageAIProcessQueue(array $query, array $json)
 * @method array DeleteImageAIProcessQueue(array $query, array $json)
 * @method array CreateImageAIProcessCallback(array $query, array $json)
 * @method array UpdateImageAIProcessQueue(array $query, array $json)
 * @method array UpdateImageAIProcessQueueStatus(array $query, array $json)
 * @method array DeleteImageAIProcessDetail(array $query, array $json)
 * @method array GetImageAIProcessQueues(array $query)
 ...
 * @method array CreateVideoAuditTask(array $query, array $json)
 * @method array CreateAudioAuditTask(array $query, array $json)
 * @method array DeleteImageAuditResult(array $json)
 * @method array GetSyncAuditResult(array $query, array $json)
 * @method array SingleImageAudit(array $query, array $json)
 * @method array BatchImageAudit(array $query, array $json)
 ...
 * @method array UpdateVideoAuditTask(array $query, array $json)
 * @method array UpdateAudioAuditTask(array $query, array $json)
 * @method array GetImageAuditTasks(array $query)
 * @method array GetImageAuditTaskResult(array $query)
 * @method array GetImageAuditResult(array $query)
 * @method array GetAuditEntrysCount(array $query)
 * @method array GetVideoAuditResult(array $query)
 * @method array GetAudioAuditResult(array $query)
