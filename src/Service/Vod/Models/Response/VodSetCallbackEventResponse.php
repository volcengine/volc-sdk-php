...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodSetCallbackEventResponse</code>
 */
class VodSetCallbackEventResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
