...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodGetMLFramesForAuditResponse</code>
 */
class VodGetMLFramesForAuditResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
