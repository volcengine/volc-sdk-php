...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodQueryMoveObjectTaskInfoResponse</code>
 */
class VodQueryMoveObjectTaskInfoResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * 通用返回结构 
     *
     ...
     * 视频上传结果 
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodQueryMoveObjectTaskInfoResData Result = 2;</code>
     */
     ...
     *           通用返回结构 
     *     @type \Volc\Service\Vod\Models\Business\VodQueryMoveObjectTaskInfoResData $Result
     *           视频上传结果 
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodQueryMoveObjectTaskInfoResData Result = 2;</code>
     * @return \Volc\Service\Vod\Models\Business\VodQueryMoveObjectTaskInfoResData|null
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodQueryMoveObjectTaskInfoResData Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\VodQueryMoveObjectTaskInfoResData $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Volc\Service\Vod\Models\Business\VodQueryMoveObjectTaskInfoResData::class);
        $this->Result = $var;
