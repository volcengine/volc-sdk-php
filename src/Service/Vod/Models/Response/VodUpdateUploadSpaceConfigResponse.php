...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodUpdateUploadSpaceConfigResponse</code>
 */
class VodUpdateUploadSpaceConfigResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
