...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodUpdateVideoClassificationResponse</code>
 */
class VodUpdateVideoClassificationResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
