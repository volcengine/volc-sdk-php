 ...
 * 点播实时处理用量
 *
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.DescribeVodRealtimeMediaDataResponse</code>
 */
class DescribeVodRealtimeMediaDataResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    /**
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.DescribeVodRealtimeMediaDataResult Result = 2;</code>
     */
     ...
     *     @type \Volc\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult $Result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.DescribeVodRealtimeMediaDataResult Result = 2;</code>
     * @return \Volc\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult|null
     */
    ...
    /**
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.DescribeVodRealtimeMediaDataResult Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Volc\Service\Vod\Models\Business\DescribeVodRealtimeMediaDataResult::class);
        $this->Result = $var;
