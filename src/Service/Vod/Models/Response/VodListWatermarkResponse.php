...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodListWatermarkResponse</code>
 */
class VodListWatermarkResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
     ...
     * 响应结果
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListWatermarkResponseResult Result = 2;</code>
     */
     ...
     *          响应通用信息
     *     @type \Volc\Service\Vod\Models\Business\VodListWatermarkResponseResult $Result
     *           响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListWatermarkResponseResult Result = 2;</code>
     * @return \Volc\Service\Vod\Models\Business\VodListWatermarkResponseResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListWatermarkResponseResult Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\VodListWatermarkResponseResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Volc\Service\Vod\Models\Business\VodListWatermarkResponseResult::class);
        $this->Result = $var;
