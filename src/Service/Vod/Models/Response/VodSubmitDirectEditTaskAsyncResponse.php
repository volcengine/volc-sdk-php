 ...
 * **********************************************************************
 *
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodSubmitDirectEditTaskAsyncResponse</code>
 */
class VodSubmitDirectEditTaskAsyncResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
     ...
     *响应结果
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.SubmitDirectEditTaskAsyncResult Result = 2;</code>
     */
     ...
     *          响应通用信息
     *     @type \Volc\Service\Vod\Models\Business\SubmitDirectEditTaskAsyncResult $Result
     *          响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.SubmitDirectEditTaskAsyncResult Result = 2;</code>
     * @return \Volc\Service\Vod\Models\Business\SubmitDirectEditTaskAsyncResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.SubmitDirectEditTaskAsyncResult Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\SubmitDirectEditTaskAsyncResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Volc\Service\Vod\Models\Business\SubmitDirectEditTaskAsyncResult::class);
        $this->Result = $var;
