...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodListWorkflowTemplateResponse</code>
 */
class VodListWorkflowTemplateResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
     ...
     * 响应结果
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListWorkflowTemplateResult Result = 2;</code>
     */
     ...
     *          响应通用信息
     *     @type \Volc\Service\Vod\Models\Business\VodListWorkflowTemplateResult $Result
     *           响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListWorkflowTemplateResult Result = 2;</code>
     * @return \Volc\Service\Vod\Models\Business\VodListWorkflowTemplateResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListWorkflowTemplateResult Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\VodListWorkflowTemplateResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Volc\Service\Vod\Models\Business\VodListWorkflowTemplateResult::class);
        $this->Result = $var;
