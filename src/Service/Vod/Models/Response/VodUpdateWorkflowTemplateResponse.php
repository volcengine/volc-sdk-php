...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodUpdateWorkflowTemplateResponse</code>
 */
class VodUpdateWorkflowTemplateResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
