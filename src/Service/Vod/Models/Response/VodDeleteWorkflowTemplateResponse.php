...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodDeleteWorkflowTemplateResponse</code>
 */
class VodDeleteWorkflowTemplateResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
