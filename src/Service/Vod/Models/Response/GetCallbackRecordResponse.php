...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.GetCallbackRecordResponse</code>
 */
class GetCallbackRecordResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
     ...
     *响应通用信息
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.CallbackRecords Result = 2;</code>
     */
     ...
     *          响应通用信息
     *     @type \Volc\Service\Vod\Models\Business\CallbackRecords $Result
     *          响应通用信息
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.CallbackRecords Result = 2;</code>
     * @return \Volc\Service\Vod\Models\Business\CallbackRecords|null
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.CallbackRecords Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\CallbackRecords $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Volc\Service\Vod\Models\Business\CallbackRecords::class);
        $this->Result = $var;
