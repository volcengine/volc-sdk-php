...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodListBlockObjectTasksResponse</code>
 */
class VodListBlockObjectTasksResponse extends \Google\Protobuf\Internal\Message
{
    /**
     * 通用返回结构 
     *
     ...
     * 发布封禁object任务结果 
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListBlockObjectTasksResult Result = 2;</code>
     */
     ...
     *           通用返回结构 
     *     @type \Volc\Service\Vod\Models\Business\VodListBlockObjectTasksResult $Result
     *           发布封禁object任务结果 
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListBlockObjectTasksResult Result = 2;</code>
     * @return \Volc\Service\Vod\Models\Business\VodListBlockObjectTasksResult|null
     */
     ...
     *
     * Generated from protobuf field <code>.Volcengine.Vod.Models.Business.VodListBlockObjectTasksResult Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\VodListBlockObjectTasksResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Volc\Service\Vod\Models\Business\VodListBlockObjectTasksResult::class);
        $this->Result = $var;
