...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodGetMediaEntityConfigListResponse</code>
 */
class VodGetMediaEntityConfigListResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
     ...
     *响应结果
     *
     * Generated from protobuf field <code>repeated .Volcengine.Vod.Models.Business.VodMediaEntityConfig Result = 2;</code>
     */
    private $Result;
     ...
     *          响应通用信息
     *     @type \Volc\Service\Vod\Models\Business\VodMediaEntityConfig[]|\Google\Protobuf\Internal\RepeatedField $Result
     *          响应结果
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .Volcengine.Vod.Models.Business.VodMediaEntityConfig Result = 2;</code>
     * @param \Volc\Service\Vod\Models\Business\VodMediaEntityConfig[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResult($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Volc\Service\Vod\Models\Business\VodMediaEntityConfig::class);
        $this->Result = $arr;
