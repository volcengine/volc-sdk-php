...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodUpdateWatermarkResponse</code>
 */
class VodUpdateWatermarkResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
