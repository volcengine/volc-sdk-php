...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Response.VodRemoveDomainFromSchedulerResponse</code>
 */
class VodRemoveDomainFromSchedulerResponse extends \Google\Protobuf\Internal\Message
{
    /**
     *响应通用信息
     *
