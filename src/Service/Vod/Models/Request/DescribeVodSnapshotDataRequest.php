 ...
 * 点播截图用量
 *
 * Generated from protobuf message <code>Volcengine.Vod.Models.Request.DescribeVodSnapshotDataRequest</code>
 */
class DescribeVodSnapshotDataRequest extends \Google\Protobuf\Internal\Message
{
    /**
     * 空间列表，多个空间用逗号分割
     *
