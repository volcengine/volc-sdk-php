...
/**
 * Generated from protobuf message <code>Volcengine.Vod.Models.Business.VodDeleteMediaData</code>
 */
class VodDeleteMediaData extends \Google\Protobuf\Internal\Message
{
    /**
     *不存在的视频VID列表
     *
