...
use Volc\Service\Vod\Models\Request\VodGetVideoDetailRequest;
use Volc\Service\Vod\Models\Response\VodGetVideoDetailResponse;
...
class Vod extends V4Curl
{
     ...
     * GetVideoDetail.
     *
     * @param $req VodGetVideoDetailRequest
     * @return VodGetVideoDetailResponse
     * @throws Exception the exception
     * @throws Throwable the exception
     */
    public function getVideoDetail (VodGetVideoDetailRequest $req): VodGetVideoDetailResponse
    {
        try {
            $query = VodUtils::formatRequestParam($req);
            $response = $this->request('GetVideoDetail', ['query' => $query]);
        } catch (Exception $e) {
            throw $e;
        } catch (Throwable $t) {
            throw $t;
        ...
        $respData = new VodGetVideoDetailResponse();
        try {
            $respData = VodUtils::parseResponseData($response, $respData);
        } catch (Exception $e) {
            throw $e;
